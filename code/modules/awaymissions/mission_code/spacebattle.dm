...
/obj/item/paper/crumpled/bloody/spacebattle/mechanic
	info = "<p> <i> Я бортовой механик NanoTrasen, состоящий в экипаже засекреченного крейсера 'Безымянный'. Если вы это читаете - я мертв. <br> Несколько часов назад наша экспедиция отправилась на тестирование экспериментальной установки, начальство говорило, что она использует какой-то 'блюспейс' - передовую технологию. Хрен его знает что за голубое пространство, но видать оно очень ценно. <br> После выстрела этой бандуры нас так тряхануло, что датчики взбесились - считали, что мы пересекли несколько десятков секторов, а календари показывали чуть ли не на 200 лет позже. <br> Судно атаковали пираты, мы пытались отбится, но их слишком много. Думаю, что все остальные мертвы. Я забаррикадировался у себя в отсеке, ворота на палубу достаточно крепкие, пока есть время - попытаюсь собрать челнок <br> Ни единого ядра, есть шанс, что на мастерской левого борта бдует хотябы одно. <br> Кажется, они догадались, что тех.тоннель ведет ко мне, надо рвать когти, пан или пропал.</i> </p>"

/obj/item/paper/crumpled/bloody/spacebattle/officer
	info = "<p> <center> <large> <b> РАПОРТ </b> </large> </center> <br> Лейтенант ТСФ Дребин, докладываю: 'Безымянный' под обстрелом, нас взяли на абардаж. После затяжного боя на всей территории крейсера, мы, видимо, проиграли... К черту эту корпортивную чушь! Мы притащили на борт крысу! Какая то сволочь точно слила наши координаты, ведь мы пробовали какую-то огромную пушку - они точно пришли за ней, только я не успел найти эту сволочь! Меня ранили... протяну от силы не больше часа, мед у нас отбили почти сразу, как сука знали! Я выберусь отсюда, я не умру в ту </p>"
...
/mob/living/simple_animal/hostile/syndicate/Initialize()
	...
	switch(rollforloot)
		...
		if(27 to 29) // 4%
			pick(
				synmobdrop = /obj/item/reagent_containers/food/pill/patch/styptic,
...
/mob/living/simple_animal/hostile/syndicate/melee/spacebattle/Initialize()
